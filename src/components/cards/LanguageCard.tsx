...
export const LanguageCard = ({ title, description, image, packages, link }: LanguageCardProps) => {
    return (
        ...
        >
            <span className="text-app-color-text-base font-clash-grotesk lg:text-2xl leading-none">{title}</span>
            <div className="flex flex-col gap-6">
                <span className="text-app-color-text-secondary font-clash-grotesk text-base">{description}</span>
